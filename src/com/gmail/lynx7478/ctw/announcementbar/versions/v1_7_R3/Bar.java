package com.gmail.lynx7478.ctw.announcementbar.versions.v1_7_R3;
...
public class Bar implements com.gmail.lynx7478.ctw.announcementbar.Bar, Listener
{
    ...
    {
        bars = new HashMap<>();
        Bukkit.getPluginManager().registerEvents(this, CTW.getInstance());
    }
